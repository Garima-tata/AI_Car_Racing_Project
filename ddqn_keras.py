...
class DDQNAgent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size,
                 ...
                 mem_size=25000, fname='ddqn_model_main.h5', replace_target=25):
...
class Brain:
    ...
    def createModel(self):
        ...
        model.add(tf.keras.layers.Dense(256, activation=tf.nn.relu, input_shape=(self.NbrStates,)))
...
# Example of usage:
# ddqn_agent = DDQNAgent(alpha=0.001, gamma=0.99, n_actions=3, epsilon=1.0,
#                        batch_size=64, input_dims=4, epsilon_end=0.01, mem_size=100000)
# ddqn_agent.learn()
